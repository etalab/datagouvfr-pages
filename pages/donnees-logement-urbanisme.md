...
- **[Enquête « Énergie et patrimoine communal » (2012-2017) :](https://www.data.gouv.fr/fr/datasets/energie-et-patrimoine-communal-5-batiments/)**
...
- **[Diagnostics de performance énergétique (DPE) pour les logements par habitation](https://www.data.gouv.fr/fr/datasets/diagnostics-de-performance-energetique-pour-les-logements-par-habitation/)**
...
- **[Recensement de la population (INSEE)](https://www.data.gouv.fr/fr/datasets/population/)**
...
- **[Bases adresses locales](https://www.data.gouv.fr/fr/datasets/adresses-locales/)**
  - Regroupe toutes les adresses d'une ou plusieurs communes et est publiée sous leur responsabilité.

- **[Données de l'observatoire des performances énergétiques OPE)](https://www.data.gouv.fr/fr/datasets/observatoire-des-performances-energetiques/)**
...
- **[Valeurs immobilières, économiques et financières de 1800 à 2015](https://www.data.gouv.fr/fr/datasets/valeurs-immobilieres-economiques-et-financieres-de-1800-a-2015/)**
...
- **[Données du plan cadastral](https://www.data.gouv.fr/fr/datasets/cadastre/)** disponibles également sur [cadastre.data.gouv.fr](https://cadastre.data.gouv.fr/)
...
- **[Annuaire des diagnostiqueurs immobiliers (ADI)](https://www.data.gouv.fr/fr/datasets/annuaire-des-diagnostiqueurs-immobiliers/)**
...
- **[Observatoires locaux des loyers](https://www.data.gouv.fr/fr/datasets/resultats-nationaux-des-observatoires-locaux-des-loyers/)**
...
- **[Coûts et surfaces moyennes des logements sociaux](https://www.data.gouv.fr/fr/datasets/couts-et-surfaces-moyennes-des-logements-sociaux/)**
...
- **[Enquête national DGALN « Eco-PTZ »](https://www.data.gouv.fr/fr/datasets/base-de-donnees-eco-ptz-eco-pret-a-taux-zero/)**
...
- **[Enquête national DGALN « PTZ »](https://www.data.gouv.fr/fr/datasets/base-de-donnees-ptz-prets-a-taux-zero/)**
...
- **[Base de données PAS (prêt à l'accession sociale)](https://www.data.gouv.fr/fr/datasets/base-de-donnee-pas-pret-a-laccession-sociale/)**
...
- **[Dispositifs Simul'Aid€s](https://www.data.gouv.fr/fr/datasets/simulaideurs-dispositifs/)**
...
- **[Plans de financement (ressources) des logements sociaux par département 2016-2018](https://www.data.gouv.fr/fr/datasets/plans-de-financement-ressources-des-logements-sociaux-par-departement-2016-2018/)**
...
- **[Financement et coût des logements sociaux construits](https://www.data.gouv.fr/fr/datasets/financement-et-cout-des-logements-sociaux-construits/)**
...
- **[Financement et coût des logements sociaux réhabilités](https://www.data.gouv.fr/fr/datasets/financement-et-cout-des-logements-sociaux-rehabilites/)**
...
- **[Compte satellite du logement CSL](https://www.data.gouv.fr/fr/datasets/compte-satellite-du-logement/)**
...
- **[Base des ÉcoQuartiers](https://www.data.gouv.fr/fr/datasets/base-des-ecoquartiers/)**
...
- **[Communes de la loi littoral au Code Officiel Géographique (COG)  2020](https://www.data.gouv.fr/fr/datasets/communes-de-la-loi-littoral-au-code-officiel-geographique-cog-2020/)**
  - Liste les communes concernées par l'application de la "loi Littoral"

- **[Communes de la loi Montagne au Code Officiel Géographique (COG) 2020](https://www.data.gouv.fr/fr/datasets/communes-de-la-loi-montagne-au-code-officiel-geographique-cog-2020/)**
  - Liste les communes concernées par l'application de la "loi Montagne" de 1985

- **[Programme Action cœur de ville ACV](https://www.data.gouv.fr/fr/datasets/programme-action-coeur-de-ville/)**
...
- **[Quartiers prioritaires de la politique de la ville - Habitat ancien dégradé](https://www.data.gouv.fr/fr/datasets/quartiers-prioritaires-de-la-polit)**
...
- **[Contrats urbains de cohésion sociale (Cucs)](https://www.data.gouv.fr/fr/datasets/contrats-urbains-de-cohesion-sociale-cucs/)**
...
- **[Quartiers de veille active QVA](https://www.data.gouv.fr/fr/datasets/quartiers-de-veille-active/)**
...
- **[Communes sélectionnées pour le programme Petites villes de demain](https://www.data.gouv.fr/fr/datasets/programme-petites-villes-de-demain/#_)**
  - Contient la liste des communes sélectionnées pour le programme Petites villes de demain.

- **[Structures d'innovation sur le territoire (non exhaustif)](https://www.data.gouv.fr/fr/datasets/structures-dinnovation-sur-le-territoire-non-exhaustif-1/)**
...
- **[Logements sociaux et bailleurs par région](https://www.data.gouv.fr/fr/datasets/logements-sociaux-et-bailleurs-par-region/)**
...
- **[Données sur mise en œuvre des PNRU](https://www.data.gouv.fr/fr/datasets/lagence-nationale-pour-la-renovation-urbaine-anru-et-la-mise-en-oeuvre-des-programmes-de-renouvellement-urbain/#_)**
...
- **[Mérimée](https://www.data.gouv.fr/fr/datasets/base-merimee-1/)**
...
- **[Base de données des permis de construire (Sitadel)](https://www.data.gouv.fr/fr/datasets/base-des-permis-de-construire-et-autres-autorisations-durbanisme-sitadel/)**
...
- **[Enquête TREMI (Travaux de Rénovation Énergétique des Maisons Individuelles)](https://www.data.gouv.fr/fr/datasets/enquete-tremi-2017/)**
...
- **[Enquête 2017-2018 : Coûts des travaux de rénovation](https://www.data.gouv.fr/fr/datasets/couts-des-travaux-de-renovation-ecs/)**
...
- **[Annuaire des espaces Conseil FAIRE](https://www.data.gouv.fr/fr/datasets/espaces-conseil-faire/)**
...
- [**Le Ministère de la Transition écologique**](https://www.data.gouv.fr/fr/organizations/ministere-de-la-transition-ecologique/), et notamment :
...
- [**Agence nationale de la cohésion des territoires (ANCT)** ](https://www.data.gouv.fr/fr/organizations/agence-nationale-de-la-cohesion-des-territoires/): Son action cible prioritairement, d'une part, les territoires caractérisés par des contraintes géographiques, des difficultés en matière démographique, économique, sociale, environnementale ou d'accès aux services publics. Principales bases gérées par l'ANCT :
...
- [**Caisse des dépôts et consignations (CDC) **](https://www.data.gouv.fr/fr/organizations/caisse-des-depots-1/): institution financière publique qui exerce des activités d'intérêt général comme la gestion d'une partie de l'épargne (Livrets A, LDDS) et le financement de projets publics et privés. Elle est notamment composée d'une branche CDC Habitat ayant un rôle de bailleur. Toutes les données ouvrables gérées par la CDC sont déjà publiées en Open Data. Principales bases gérées par la CDC :
...
- Au sein du [Ministère de la Transiton écologique](https://www.data.gouv.fr/fr/organizations/ministere-de-la-transition-ecologique/) :
...
- [Centre d'études et d'expertise sur les risques, l'environnement, la mobilité et l'aménagement (CEREMA)](https://www.data.gouv.fr/fr/organizations/cerema/)

- [Institut national de l'information géographique et forestière (IGN)](https://www.data.gouv.fr/fr/organizations/institut-national-de-l-information-geographique-et-forestiere/)

- [Observatoire des performances énergétiques (OPE)](https://www.observatoire-dpe.fr/)

- [Agence Nationale pour la Renovation Urbaine (ANRU)](https://www.data.gouv.fr/fr/organizations/agence-nationale-pour-la-renovation-urbaine/)
